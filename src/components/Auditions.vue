  ...
  <div class="app">
    <div>
      ...
      <b-row class="mx-auto pt-5">
        ...
        <b-list-group>
<b-list-group-item><strong>5:00pm-6:00pm</strong> - This class is <strong>NOT</strong> required for auditions, but is highly recommended. This class has a $25 fee.<br/>
</b-list-group-item> 
